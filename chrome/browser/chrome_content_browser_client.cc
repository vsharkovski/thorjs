// Copyright 2024 The Chromium Authors, Alex313031, and Vladimir Sharkovski
...
ChromeContentBrowserClient::CreateURLLoaderThrottles(
  ...
  if (auto thorzeel_throttle = thorzeel::ThorzeelThrottle::MaybeCreate(
          request,
          content::GetUIThreadTaskRunner({content::BrowserTaskType::kDefault}));
      thorzeel_throttle) {
    result.push_back(std::move(thorzeel_throttle));
  }
